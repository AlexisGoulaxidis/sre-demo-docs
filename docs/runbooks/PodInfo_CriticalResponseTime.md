...
Impact: Podinfo: КРИТИЧЕСКОЕ время ответа > 5с, пользователи массово получают ошибки таймаута или долгих зависаний в работе сервиса
    ...
    Если проблема связана с резким ростом нагрузки CPU/MEM следует увеличить количество реплик сервиса пропорционально возросшей нагрузке
    ...
    Если ошибка не исправлена и проблема связана с вводом нового релиза сервиса podinfo следует откатить helm релиз
